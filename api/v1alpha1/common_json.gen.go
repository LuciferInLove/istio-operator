...
// MarshalJSON is a custom marshaler for ProbeHandler
func (this *ProbeHandler) MarshalJSON() ([]byte, error) {
	str, err := CommonMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for ProbeHandler
func (this *ProbeHandler) UnmarshalJSON(b []byte) error {
	return CommonUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}
