...
// DeepCopyInto supports using ProbeHandler within kubernetes types, where deepcopy-gen is used.
func (in *ProbeHandler) DeepCopyInto(out *ProbeHandler) {
	p := proto.Clone(in).(*ProbeHandler)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProbeHandler. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new ProbeHandler. Required by controller-gen.
func (in *ProbeHandler) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
